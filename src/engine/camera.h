...
class Camera {
  public:
    ...
    void Render(SDL_Texture* texture, const SDL_Rect* src_rect, const SDL_Rect* dst_rect) const;
    // Render textures statically, not within the frame of the camera.
    void RenderStatic(SDL_Texture* texture, SDL_Rect* src_rect, SDL_Rect* dst_rect) const;
