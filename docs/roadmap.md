...
- Puppet editor: full polygon clipping; explicit ownership/overlap validation;
  source-rig updates that can deliberately adopt moved joints. Existing
  overlapping artwork needs an art decision before its ownership changes.
