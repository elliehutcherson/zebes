...
| 5 | Game runtime: `run_game`, simulation, player, thread split | **In progress in parallel with Track 4** — the shared runtime-neutral scene core is extracted; Milestone 1 continues with pacing and `run_game` without blocking asset/content work |
