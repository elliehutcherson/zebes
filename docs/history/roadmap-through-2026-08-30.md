...
resume points and last verified checkpoint; [`history/handoff.md`](handoff.md)
and the other records under [`history/`](README.md) preserve earlier
...
**Layers — done.**
[`history/level-layers.md`](level-layers.md) records the implemented
...
implementation sequence is [`zone-fades.md`](zone-fades.md).
...
[historical evidence](animation-pose-conditioned-experiment.md), not a
