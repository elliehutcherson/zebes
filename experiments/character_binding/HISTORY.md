# Character-binding implementation history

Historical record through 2026-09-12. All "current" work and pending gates
below describe the retired 2D route. Use [README.md](README.md) for the index
and the [3D mouse plan](../../docs/mouse-3d-plan.md) for current work.

**Work resumed 2026-09-10 in the separate [sprite sequence experiment](../sprite_sequence/README.md).**
The fresh audit and C++ profile control preserve this experiment's inputs and
evidence. The earlier [six rejected boot/leg results](../../docs/history/sprite-boot-control-2026-09-10.md)
remain rejected.
