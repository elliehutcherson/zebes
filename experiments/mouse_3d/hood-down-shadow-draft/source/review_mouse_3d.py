...
def main():
    ...
    if args.previous:
        ...
        for index, (label, path) in enumerate((("BEFORE / HOOD UP", args.previous / "hero.png"),
                                                ("REVISED / HOOD DOWN", out / "hero.png"))):
